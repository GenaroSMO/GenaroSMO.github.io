<%-- 
    Document   : Registro_de_Horas_a_Planta_Alta
    Created on : 28/08/2019, 09:38:13 PM
    Author     : DELL02
...
<html>
    ...
    <body>
        ...
        <form action="RH_Control_Planta_Alta.jsp"  method="post" style="<%=IMGCarrera%>" > 
            <br/>
            <table >
                <tr  >     
                    ...
                    <td WIDTH="490"> 
                        <table >
                            ...
                            <tr> 
                                <td   HEIGHT="30" class="Apellidos_Del_Alumno"> <%= Apellidos%> </td>
                            </tr>
