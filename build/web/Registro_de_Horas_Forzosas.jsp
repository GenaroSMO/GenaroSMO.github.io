<%-- 
    Document   : Registro_de_Horas_Forzosas
    Created on : 9/09/2019, 10:08:28 AM
    Author     : DELL02
--%>
...
<html>
    ...
    <body>
        ...
        <form action="RHF_Control.jsp"  method="post" style="<%=IMGCarrera%>" > 
            <br/>
            <table border="0">
                <tr  >     
            ...
            <table border="0">
                <tr>     
                    ...
                    <td  WIDTH="200"> <input type="text" name="txtMatricula"   placeholder="Matricula" required class="caja" > </td>
                    <td  WIDTH="100"> <input type="number" placeholder="Horas" name="Horas" value="1" required class="caja"> </td>
            ...
            <table border="0">
                <tr>     
                    <td  WIDTH="10"  HEIGHT="30"></td>
                    <td  WIDTH="200"  HEIGHT="50">  <center> <a class="boton" href="Menu_Administrador.jsp" >Regresar</a>   </center></td>
