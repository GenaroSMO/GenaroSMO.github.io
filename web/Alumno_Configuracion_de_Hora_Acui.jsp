<%-- 
    Document   : Alumno_Configuracion_de_Hora_Acui
    Created on : 5/09/2019, 11:26:19 AM
    Author     : DELL02
--%>
    ...
    <body  >
        ...
        <%
            ...
            try {
                ...
                Configuracion_De_Hora_Lst = TA.Alumno_Configuracion_de_HoraLista(6);
        ...
        <form class="formConfiguracionDeHora" action="Control_Alumno_configuracion_de_Hora.jsp"   method="post" >
            ...
            <table border="0">
                <tr>
                    <td  WIDTH="20" HEIGHT="20"  > </td>
                    <td WIDTH="200" HEIGHT="20"  > <input type="text" name="IdCarrera" value="C006"  style="display:none"></td>
                    <td WIDTH="200" HEIGHT="20"  > <input type="text" name="Ventana" value="Alumno_Configuracion_de_Hora_Acui.jsp"  style="display:none"> </td>
